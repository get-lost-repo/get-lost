...
var dataBack = JSON.parse(localStorage.getItem('lowlandsCommentsStringified'));
...
renderAllComments();
localStorage.setItem('lowlandsCommentsStringified', JSON.stringify(belfairComments));
return;
}
