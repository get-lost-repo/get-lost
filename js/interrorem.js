...
var dataBack = JSON.parse(localStorage.getItem('interroremCommentsStringified'));
...
renderAllComments();
localStorage.setItem('interroremCommentsStringified', JSON.stringify(belfairComments));
return;
}
