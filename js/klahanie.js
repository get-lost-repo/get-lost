...
var dataBack = JSON.parse(localStorage.getItem('klahanieCommentsStringified'));
...
renderAllComments();
localStorage.setItem('klahanieCommentsStringified', JSON.stringify(belfairComments));
return;
}
