...
var dataBack = JSON.parse(localStorage.getItem('klahowyaCommentsStringified'));
...
renderAllComments();
localStorage.setItem('klahowyaCommentsStringified', JSON.stringify(belfairComments));
return;
}
