...
var dataBack = JSON.parse(localStorage.getItem('staircaseCommentsStringified'));
...
renderAllComments();
localStorage.setItem('staircaseCommentsStringified', JSON.stringify(belfairComments));
return;
}
